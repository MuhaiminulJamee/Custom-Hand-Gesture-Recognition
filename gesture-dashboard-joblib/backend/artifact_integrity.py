...
RUNTIME_PATTERNS = (
    ...
    "gesture_production_selection.json",
    "gesture_production_qualification.json",
    "*models.joblib",
)
...
class ArtifactRegistry:
    ...
    def verify(self) -> dict[str, Any]:
        with self._lock:
            ...
            ) or any(name.endswith("models.joblib") for name in names)
            if not classifier_present:
                errors.append("No classifier artifact is registered.")
            return {
                "verified": not errors,
